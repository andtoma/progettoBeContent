<?php
 ...
 Class formTag extends TagLibrary {
 		...
 		while ($x<count($data)) {
 			...
 			$content .= "<tr>\n";
 			 ...
 			 $content .= "<td>\n";
 		  	 ...
 		  	 $message=$GLOBALS['message']->getMessage(MODALITY1);			
 		  	 $content.="<tr>\n";
 		     ...
 		     $content.="</tr>\n";
 		     $message=$GLOBALS['message']->getMessage(MODALITY2);
 		     $content.="<tr>\n";
 		     ...
 		     $content.="</tr>\n";
 		     $message=$GLOBALS['message']->getMessage(MODALITY3);
 		     $content.="<tr>\n";
 		     $content.="<td style=\"padding-left: 10px;\">\n";
