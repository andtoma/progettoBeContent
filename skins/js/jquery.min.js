...
(function(window, undefined) {
	...
	if (!jQuery.support.opacity) {
		jQuery.cssHooks.opacity = {
			...
			set : function(elem, value) {
				var style = elem.style, currentStyle = elem.currentStyle, opacity = jQuery.isNaN(value) ? "" : "alpha(opacity=" + value * 100 + ")", filter = currentStyle && currentStyle.filter || style.filter || "";
	...
	jQuery.extend({
		...
		ajax : function(url, options) {
			...
			// Deferreds
			deferred = jQuery.Deferred(), completeDeferred = jQuery._Deferred(),
