 ...
 */! function(a) {"use strict";
	...
	b.prototype = {
		init : function() {
			...
			}), b.options.caret && b.$el.find("li:has(ul) > a").append(b.options.caret);
			var c = b.$el.find("li > a");
			c.on("click", function(c) {
				c.stopPropagation();
				var d = a(this).next();
				if ( d = d.length > 0 ? d : !1, b.options.onClickBefore.call(this, c, d), d)
					c.preventDefault(), b._toggle(d, d.is(":hidden")), b._save();
				else if (b.options.accordion) {
					var e = b.state = b._parents(a(this));
					b.$el.find("ul").filter(":visible").each(function() {
						var c = a(this), d = c.attr("data-index");
						e.hasOwnProperty(d) || b._toggle(c, !1)
					}), b._save()
				}
				b.options.onClickAfter.call(this, c, d)
			})
		},
		_toggle : function(b, c) {
			...
			if (d.options.onToggleBefore.call(this, b, c), c) {
				...
				f.removeClass(d.options.openClass), b.slideUp(d.options.slide), d.state[e] = 0;
		...
		destroy : function() {
			a.removeData(this.$el), this.$el.find("li:has(ul) > a").unbind("click")
		}
	}, a.fn.navgoco = function(c) {
		if ("string" == typeof c && "_" !== c.charAt(0) && "init" !== c)
			var d = !0, e = Array.prototype.slice.call(arguments, 1);
		else
			c = a.extend({}, a.fn.navgoco.defaults, c || {}), a.cookie || (c.save = !1);
